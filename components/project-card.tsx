...
export function ProjectCard({ project }: { project: Project }) {
  ...
  return (
    <motion.div
      ...
      className="group relative flex flex-col rounded-2xl border border-border bg-card transition-all duration-300 hover:border-primary/40 hover:shadow-lg dark:hover:shadow-primary/5"
    >
      {/* Top accent bar */}
